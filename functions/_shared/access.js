...
export function renderAccessGatePage(request, options = {}) {
  ...
  return [
    ...
    ".secondary-link{display:flex;align-items:center;justify-content:center;width:fit-content;margin:12px auto 0;color:var(--discord);text-decoration:none;transition:transform .16s ease,filter .16s ease}",
