(function () {
  ...
  function getConfiguredMediaProxyOrigin() {
    ...
    try {
      if (IS_STATIC_EDGE_HOST && STATIC_EDGE_MEDIA_PROXY_ORIGIN) {
        return new URL(STATIC_EDGE_MEDIA_PROXY_ORIGIN, window.location.origin).origin;
      }
    } catch (_error) {}
  ...
  function ensureAccessGateStyles() {
    ...
    style.textContent = [
      ...
      "  width: min(100%, 460px);",
      "  background: linear-gradient(180deg, rgba(18, 18, 18, 0.94), rgba(8, 8, 8, 0.92));",
      "  border-radius: 28px;",
      "  box-shadow: 0 40px 120px rgba(0, 0, 0, 0.48), inset 0 1px 0 rgba(255, 255, 255, 0.04);",
      ...
      "  border: none;",
      "  border-radius: 999px;",
      "  background: linear-gradient(135deg, #ff2a36 0%, #e50914 52%, #b20710 100%);",
      "  box-shadow: 0 20px 46px rgba(229, 9, 20, 0.24), inset 0 1px 0 rgba(255, 255, 255, 0.18);",
      "  color: #ffffff;",
      "  font-size: 15px;",
      "  font-weight: 800;",
      ...
      "}",
      `#${ACCESS_GATE_ROOT_ID} button:hover {`,
      "  filter: brightness(1.05);",
      "  box-shadow: 0 24px 54px rgba(229, 9, 20, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.22);",
      "}",
      `#${ACCESS_GATE_ROOT_ID} button:focus-visible {`,
      "  box-shadow: 0 0 0 4px rgba(229, 9, 20, 0.18), 0 20px 46px rgba(229, 9, 20, 0.24), inset 0 1px 0 rgba(255, 255, 255, 0.18);",
      "}",
      ...
      `  #${ACCESS_GATE_ROOT_ID} .access-shell { padding: 24px 20px; border-radius: 24px; }`,
